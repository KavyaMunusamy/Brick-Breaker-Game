...
class GamePanel extends JPanel implements KeyListener, ActionListener {
    ...
    public GamePanel() {
        forestImage = new ImageIcon("C:\Users\Kavya\OneDrive\Pictures\Saved Pictures\background.jpg").getImage();
        carrotImage = new ImageIcon("C:/Users/harin/Downloads/carrotimg.png").getImage();
        rabbitImage = new ImageIcon("C:\Users\Kavya\OneDrive\Pictures\Saved Pictures\download (1).jpg").getImage();
    ...
    public void paint(Graphics g) {
        ...
        g.setColor(new Color(0x4169E1)); // Paddle color (Royal Blue)
